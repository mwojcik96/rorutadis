...
#' Find a max-min formulation function
#'
#' This function finds single value function that is consistent with provided preferece information.
#' Search is done by delta maximization.
#' 
#' @param problem Problem
#' @return List with named elements:
#' \itemize{
...
#' problem <- addAssignmentsLB(problem, c(1, 2), c(2, 3))
#' 
#' simpleFunction <- findMaxMinFormulationFunction(problem)
#' @export
findMaxMinFormulationFunction <- function(problem) {
  model <- buildModel(problem, FALSE, TRUE, FALSE)
  solution <- maximizeDelta(model)
...
#' Find a max theta function
#'
#' This function finds single value function that is consistent with provided preferece information.
#' Search is done by theta maximization.
#' 
#' @param problem Problem
#' @return List with named elements:
#' \itemize{
...
#' problem <- addAssignmentsLB(problem, c(1, 2), c(2, 3))
#' 
#' simpleFunction <- findMaxThetaFunction(problem)
#' @export
findMaxThetaFunction <- function(problem) {
  model <- buildModel(problem, FALSE, FALSE, TRUE)
  solution <- maximizeTheta(model)
...
#' Find a max theta and delta sum function
#'
#' This function finds single value function that is consistent with provided preferece information.
#' Search is done by sum of theta and delta maximization.
#' 
#' @param problem Problem
#' @return List with named elements:
#' \itemize{
...
#' problem <- addAssignmentsLB(problem, c(1, 2), c(2, 3))
#' 
#' simpleFunction <- findMaxThetaAndDeltaFunction(problem)
#' @export
findMaxThetaAndDeltaFunction <- function(problem) {
  model <- buildModel(problem, FALSE, TRUE, TRUE)
  solution <- maximizeThetaAndDelta(model)
